...
#include "hello_triangle_indirect.h"
 ...
 */
bool HelloTriangleIndirect::validate_extensions(const std::vector<const char *>          &required,
 ...
 */
void HelloTriangleIndirect::init_instance()
{
 ...
 */
void HelloTriangleIndirect::init_device()
{
 ...
 */
void HelloTriangleIndirect::init_vertex_buffer()
{
 ...
 */
void HelloTriangleIndirect::init_per_frame(PerFrame &per_frame)
{
 ...
 * @param per_frame The data of a frame.
 */
void HelloTriangleIndirect::teardown_per_frame(PerFrame &per_frame)
{
 ...
 */
void HelloTriangleIndirect::init_swapchain()
{
 ...
 */
void HelloTriangleIndirect::init_render_pass()
{
 ...
 */
VkShaderModule HelloTriangleIndirect::load_shader_module(const std::string &path)
{
 ...
 */
void HelloTriangleIndirect::init_pipeline()
{
 ...
 */
VkResult HelloTriangleIndirect::acquire_next_image(uint32_t *image)
{
 ...
 */
void HelloTriangleIndirect::render_triangle(uint32_t swapchain_index)
{
 ...
 * @returns Vulkan result code
 */
VkResult HelloTriangleIndirect::present_image(uint32_t index)
{
 ...
 */
void HelloTriangleIndirect::init_framebuffers()
{
...
HelloTriangleIndirect::HelloTriangleIndirect()
{
}
...
bool HelloTriangleIndirect::prepare(const vkb::ApplicationOptions &options)
{
...
void HelloTriangleIndirect::update(float delta_time)
{
	uint32_t index;
...
bool HelloTriangleIndirect::resize(const uint32_t, const uint32_t)
{
	if (context.device == VK_NULL_HANDLE)
	{
		return false;
...
std::unique_ptr<vkb::Application> create_hello_triangle_indirect()
{
	return std::make_unique<HelloTriangleIndirect>();
}
