...
#include "hpp_hello_triangle_indirect.h"
...
HPPHelloTriangleIndirect::HPPHelloTriangleIndirect()
{
}
...
bool HPPHelloTriangleIndirect::prepare(const vkb::ApplicationOptions &options)
{
...
void HPPHelloTriangleIndirect::update(float delta_time)
{
	vk::Result res;
	uint32_t   index;
...
bool HPPHelloTriangleIndirect::resize(const uint32_t, const uint32_t)
{
	if (!device)
	{
		return false;
 ...
 */
std::pair<vk::Result, uint32_t> HPPHelloTriangleIndirect::acquire_next_image()
{
...
vk::Device HPPHelloTriangleIndirect::create_device(const std::vector<const char *> &required_device_extensions)
{
...
vk::Pipeline HPPHelloTriangleIndirect::create_graphics_pipeline()
{
...
vk::ImageView HPPHelloTriangleIndirect::create_image_view(vk::Image image)
{
...
vk::Instance HPPHelloTriangleIndirect::create_instance(std::vector<const char *> const &required_instance_extensions, std::vector<const char *> const &required_validation_layers)
{
...
vk::RenderPass HPPHelloTriangleIndirect::create_render_pass()
{
 ...
 */
vk::ShaderModule HPPHelloTriangleIndirect::create_shader_module(std::string const &path)
{
...
vk::SwapchainKHR
    HPPHelloTriangleIndirect::create_swapchain(vk::Extent2D const &swapchain_extent, vk::SurfaceFormatKHR surface_format, vk::SwapchainKHR old_swapchain)
{
	vk::SurfaceCapabilitiesKHR surface_properties = gpu.getSurfaceCapabilitiesKHR(surface);
...
std::pair<vk::Buffer, VmaAllocation> HPPHelloTriangleIndirect::create_vertex_buffer()
{
...
VmaAllocator HPPHelloTriangleIndirect::create_vma_allocator()
{
 ...
 */
void HPPHelloTriangleIndirect::init_framebuffers()
{
 ...
 */
void HPPHelloTriangleIndirect::init_swapchain()
{
	vk::SurfaceCapabilitiesKHR surface_properties = gpu.getSurfaceCapabilitiesKHR(surface);
 ...
 */
void HPPHelloTriangleIndirect::render_triangle(uint32_t swapchain_index)
{
 ...
 */
void HPPHelloTriangleIndirect::select_physical_device_and_surface()
{
 ...
 */
void HPPHelloTriangleIndirect::teardown_framebuffers()
{
 ...
 */
void HPPHelloTriangleIndirect::teardown_per_frame(FrameData &per_frame_data)
{
...
std::unique_ptr<vkb::Application> create_hpp_hello_triangle_indirect()
{
	return std::make_unique<HPPHelloTriangleIndirect>();
}
